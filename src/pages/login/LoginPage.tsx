      ...
      <div className="flex justify-center h-screen">
        ...
        >
          <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
            <div>
              <h2 className="text-2xl font-bold text-white sm:text-3xl">NoaGuard</h2>
              <p className="max-w-xl mt-3 text-gray-300">
                Bienvenido a NoaGuard, el sistema integral para la gestión moderna de tu daycare.
              </p>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring focus:ring-blue-400 focus:ring-opacity-40 focus:outline-none"
                    disabled={loading}
                    required
                  />
                </div>
